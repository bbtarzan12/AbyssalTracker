...
if __name__ == "__main__":
    ...
    dummy_stats_data = {
        "daily_stats": {
            "2025-06-01": {
                "runs": [
                    {"시작시각(KST)": "2025-06-01 10:00:00", "어비셜 종류": "T1 Electrical", "런 소요(분)": 5.5, "드롭": 10000000, "입장료": 1000000, "실수익": 9000000, "ISK/h": 98181818},
                    {"시작시각(KST)": "2025-06-01 11:00:00", "어비셜 종류": "T1 Exotic", "런 소요(분)": 6.0, "드롭": 12000000, "입장료": 1000000, "실수익": 11000000, "ISK/h": 110000000}
                ],
                "avg_isk": 10000000,
                "avg_time": 5.75,
                "avg_iskph": 104000000
            ...
            "2025-06-02": {
                "runs": [
                    {"시작시각(KST)": "2025-06-02 14:00:00", "어비셜 종류": "T2 Gamma", "런 소요(분)": 7.0, "드롭": 15000000, "입장료": 2000000, "실수익": 13000000, "ISK/h": 111428571}
                ],
                "avg_isk": 13000000,
                "avg_time": 7.0,
                "avg_iskph": 111428571
        ...
        "overall_stats": {
            ...
            "avg_iskph": 106000000,
            "tier_weather_stats": [
                {"tier": "T1", "weather": "Electrical", "runs_count": 1, "avg_isk": 9000000, "avg_time": 5.5, "avg_iskph": 98181818},
                {"tier": "T1", "weather": "Exotic", "runs_count": 1, "avg_isk": 11000000, "avg_time": 6.0, "avg_iskph": 110000000},
                {"tier": "T2", "weather": "Gamma", "runs_count": 1, "avg_isk": 13000000, "avg_time": 7.0, "avg_iskph": 111428571}
            ]
        }
    }
    ...
    AbyssalStatsDisplayPopup.set_parent_root(root)
    popup = AbyssalStatsDisplayPopup(dummy_stats_data)
    root.mainloop()